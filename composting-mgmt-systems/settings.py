"""
Django settings for composting-mgmt-systems project.
...
ROOT_URLCONF = 'composting-mgmt-systems.urls'
...
WSGI_APPLICATION = 'composting-mgmt-systems.wsgi.application'
