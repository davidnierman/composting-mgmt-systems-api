# Generated by Django 3.0 on 2022-06-22 14:47
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.CharField(choices=[('CUSTOMER', 'customer'), ('DRIVER', 'driver'), ('ROUTE MANAGER', 'route manager')], max_length=15)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('bin_model_foreign_key', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='api.Bin_Model')),
                ('location_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='api.Location')),
            ],
        ),
    ]
